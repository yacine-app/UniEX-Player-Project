...
public class PlayerService extends MediaBrowserServiceCompat implements PlayerCore.ErrorListener {
    ...
    private void updateNotification(){
        ...
        if(isPlaying()){
            collapsedRemoveView.setImageViewResource(R.id.play_pause_action_notification, R.drawable.ic_pause_icon);
            expandedRemoveView.setImageViewResource(R.id.play_pause_action_notification, R.drawable.ic_pause_icon);
        }else {
            collapsedRemoveView.setImageViewResource(R.id.play_pause_action_notification, R.drawable.ic_play_icon);
            expandedRemoveView.setImageViewResource(R.id.play_pause_action_notification, R.drawable.ic_play_icon);
        }
